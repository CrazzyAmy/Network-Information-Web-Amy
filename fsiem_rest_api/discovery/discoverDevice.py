...
def restPost(appServer, user, password, file):
    ...
    content = f.read()
    f.close()
    url = 'https://' + appServer + '/phoenix/rest/deviceMon/discover'
...
if __name__ == '__main__':
    if len(sys.argv) != 5:
        print('Usage: discoverDevice.py appServer user password deviceDefFile')
        print('Example: python discoverDevice.py 192.168.20.116 super/admin adm1n deviceDef.xml')
        sys.exit()
