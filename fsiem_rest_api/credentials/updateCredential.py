...
def restPost(appServer, user, password, file):
    ...
    content = f.read()
    f.close()
    url = 'https://' + appServer + '/phoenix/rest/deviceMon/updateCredential'
...
if __name__ == '__main__':
    if len(sys.argv) != 5:
        print('Usage: updateCredential.py appServer user password credentialDefFile')
        print('Example: python updateCredential.py 192.168.20.116 super/admin adm1n credentialDef.xml')
        sys.exit()
