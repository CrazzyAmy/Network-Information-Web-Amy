...
def restPost(appServer, user, password, file):
    ...
    content = f.read()
    f.close()
    url = 'https://' + appServer + '/phoenix/rest/organization/update'
...
if __name__ == '__main__':
    if len(sys.argv) != 5:
        print ("Usage: updateOrg.py appServer user password orgDefFile")
        print ("Example: python updateOrg.py 192.168.20.116 super/admin adm1n orgDef.xml")
        sys.exit()
