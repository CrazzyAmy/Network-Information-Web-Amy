...
def restPost(appServer, user, password, file):
    ...
    content = f.read()
    f.close()
    url = 'https://' + appServer + '/phoenix/rest/deviceMaint/delete'
...
if __name__ == '__main__':
    if len(sys.argv) != 5:
        print('Usage: deleteMaint.py appServer user password scheduleDefFile')
        print('Example: python deleteMaint.py 192.168.20.116 super/admin adm1n scheduleDef.xml')
        sys.exit()
