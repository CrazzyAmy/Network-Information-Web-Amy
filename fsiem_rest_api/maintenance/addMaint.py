...
def restPost(appServer, user, password, file):
    ...
    content = f.read()
    f.close()
    url = 'https://' + appServer + '/phoenix/rest/deviceMaint/update'
...
if __name__ == '__main__':
    if len(sys.argv) != 5:
        print('Usage: addMaint.py appServer user password scheduleDefFile')
        print('Example: python addMaint.py 192.168.20.116 super/admin adm1n scheduleDef.xml')
        sys.exit()
